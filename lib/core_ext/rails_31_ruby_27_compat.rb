# Rails 3.1 compatibility patches for Ruby 2.7+
# Uses module prepending to fix runtime errors (frozen string issues)
# Note: Syntax errors (circular argument references) must be fixed by direct
# file patching in boot.rb before the files are loaded

module Rails31Ruby27Compat
