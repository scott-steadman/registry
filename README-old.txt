...
=== Installation
  ...
  # Gemfile
  gem 'registry', :git => 'https://github.com/scott-steadman/registry.git'

== Testing/Coverage

  # setup test environment
  rbenv install `cat .ruby-version`  # if you don't have the ruby version installed
  bundle install --clean --path=vendor/bundle
  bundle exec rake db:migrate

  # run tests
  rm -f db/test.sqlite3 && bundle exec rake db:test:prepare test

  # view coverage report at: http://localhost:3000/coverage/
